 ...
 *
 * Returns the cell coordinates if a valid sequence is found AND marks
 * those cells as used to prevent overlap. Returns null otherwise.
 *
...
function findSequence(
  ...
  // Valid sequence found — mark all cells as used and collect coordinates
 ...
 * @returns Result with is_mutant flag and the coordinates of all found sequences
 */
